...
while(simTime<planTime)
    ...
    for i=0:intepolate-1
        ...
        plotAllwP(width,height,tempRobotStates,GoalRobotStates,TRNum,PodStates,PickupStationStates,DeliveryStationStates,ColorMat,priorityVec);
        frame = getframe;
